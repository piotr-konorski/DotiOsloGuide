...
if (isset($_POST['Email'])) {
    ...
    $email_subject = "Message from webpage (konorska.com)";
...
?>
    ...
    <div style="margin:0 auto;text-align: center;max-width: 400px;">
        <br>
        <p style="font-family: Lato, sans-serif;">Thank you for contacting me! I will be in touch with You very soon.</p>
